...
import StyledSingleCharacter from "./StyledSingleCharacter";
        ...
        return (
            <Container>
                <StyledSingleCharacter>
                    {
                        shout &&
                        <div className='rick___shouts'>
                            <p>
                                Sure Morty, if that's how you want to live your boring life!
                            </p>

                            <div>
                                <button onClick={() => { props.history.push('/') }} className="positiveAction">
                                    O.. O.. Okay Rick
                                </button>

                                <button onClick={() => setShout(false)} className="negativeAction">
                                    Jeez Rick!
                            </button>
                            </div>
                        </div>
                    ...
                    <div className="char__desc">
                        ...
                        <div className="primary__info">
                            <div>
                                <p>Created</p>
                                <p>{moment(char.created).fromNow(true)} ago</p>
                            </div>
                            <div>
                                <p>Location</p>
                            ...
                            <div>
                                <p>Total Episodes</p>
                                <p>{char.episode.length || 'NA'}</p>
                            </div>
                        </div>
                    </div>
                    <div className='backButton'>
                        <button onClick={() => setShout(true)}>
